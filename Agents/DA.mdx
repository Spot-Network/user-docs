...
It can swiftly respond to your queries, providing insights and finding specific information within these complex sources of data.

>**This agent is particularly useful when you want to build a workflow that is capable of answering complext questions from long books or documents**
...
- **Config**: In the configurations menu, the model can be trained on PDF, Files locate on google drive or a website.
...
>**Agents always have to be trained until the message below is shown. You can train your agent by clicking the button `Train Agent`**
