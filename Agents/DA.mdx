...
description: 'This agent answers any question by learning from any text based source you give it.'
---

The `Documentation Agent` is designed to effortlessly learn from various sources, including Google Drive text files and PDFs. 
