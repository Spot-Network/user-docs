...
description: 'Compare the AI models that we provide access in Spot'
---

The `AI text generation` module is capable of using any of the models below to generate text. 
...
The image AI modules are capable of using any of the models below to generate images. 
