...
1. [**Clear and Concise Language**](/Prompt/CCT)
2. [**Few-Shot Prompting**](/Prompt/Multishot)
3. [**Let the AI Think**](/Prompt/let-the-ai-think)
4. [**Assign a Role to the AI**](/Prompt/assign-role-to-ai)
8. [**Selecting the right AI Model**](/Prompt/Select-model)
